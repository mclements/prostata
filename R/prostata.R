...
FhcrcParameters <- list(
    ...
    hr_locoregional=transform(expand.grid(age=c(50,60,70),ext_grade=0:2,psa10=0:1),
                              hr = c(0.2247162, 0.4960436, 0.9456394,
                                     2.1490413, 1.5724969, 1.7237184,
                                     0.8844311, 0.9167291, 1.5759394,
                                     1.8576926, 0.9722557, 1.1463573,
                                     4.0513295, 2.3571453, 2.4214324,
                                     0.8832612, 0.8544890, 0.9010941)),
    hr_metastatic=data.frame(age = c(50, 60, 70),
                             hr = c(0.8196492, 0.8065353, 0.7210953)),
