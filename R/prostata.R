...
FhcrcParameters <- list(
    ...
    c_benefit_type = 0, # 0=stage-shift (=> c_benefit_value0=10), 1=lead-time based (=> c_benefit_value1=0.1), 2=hybrid (uses c_benefit_value{0,1})
    ...
    round_specific_p_mri=FALSE,           # flag for whether to use round-specific pMRIpos characteristics (and then use the following three)
    pMRIposG0_r2=0.184292645141448,          # Pr(MRI+ | ISUP 0 || undetectable)
    pMRIposG1_r2=0.316652231007673,          # Pr(MRI+ | ISUP 1 && detectable)
    pMRIposG2_r2=0.836863636375978,          # Pr(MRI+ | ISUP 2+ && detectable)
...
callFhcrc <- function(n=10, screen= "noScreening", nLifeHistories=10,
    ...
    eventT <- c("toLocalised","toMetastatic","toClinicalDiagnosis", "toCancerDeath",
                ...
                "toPalliative", "toTerminal", "toDRE", "toGRS", "toPosMRI","toGRSInitiatedFollowUp")
