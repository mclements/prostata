...
FhcrcParameters <- list(
    ...
    grs_frailty = 0.68,           # Callender et al (2019)
    other_frailty = 1.14          # total variance = 1.82 from Kicinski et al (2011; https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0027130)
)
...
90, 90, 90, 90, 90, 90), total_cat = c(0, 3, 4, 6, 10, 20, 0,
3, 4, 6, 10, 20, 0, 3, 4, 6, 10, 20, 0, 3, 4, 6, 10, 20, 0, 3,
4, 6, 10, 20, 0, 3, 4, 6, 10, 20, 0, 3, 4, 6, 10, 20, 0, 3, 4,
6, 10, 20), shape = c(1.18510576695807, 0.858171614262325, 0.858171614262325,
...
0.978397483932468), cure = c(0.114600739520109, 0.0537234127141967,
...
0.151125704749819, 0.151125704749819), scale = c(6.58183283712968,
